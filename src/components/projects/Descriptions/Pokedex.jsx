      ...
      <div className="description-body dex-body">
        ...
        <div className="desc-main-body">
          ...
          <p className="paragraph">
            ...
            <Link href="https://pokeapi.co/">Pokéapi.co.</Link> The beating
            heart of this app is a trie data structure to store and search
            through Pokémon names and render them into an autocompleting list as
            the user typed in the search bar. Pokémon data is then rendered into
            a simple template displaying flavor text entries, in-game stats as
            well as links to other forms of the Pokémon and any other Pokémon in
            their evolution tree.
          </p>
          <DescImage src="dex-example.png" caption="An example pokédex entry" />
          ...
          <DescImage src="Trie.jpg" caption="The trie in action" />
          <p className="paragraph">
            ...
            I needed to use <Link href="https://lodash.com/">Lodash</Link> to
            parse the names into what they call start case (capitalize the first
            letter of each word), but I ran into problems with Pokémon whose
            names had hyphens in them, such as Ho-Oh and Kommo-o. I solved this
            by running each name against several lists of different types of
            hyphenation and capitalisation before inserting them into the trie.
            Thankfully there are only a handful of situations where this is the
            case, but if Gamefreak ever releases a generation of Pokémon where
            all the names are hyphenated, this could add some performance issues
            to my application. Lodash is also used to parse the input data into
            kebab case in order to interface with the trie.
          </p>
          <p className="paragraph">
